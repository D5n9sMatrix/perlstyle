define("ace/keyboard/vim", ["require", "exports", "module", "ace/range", "ace/lib/event_emitter", "ace/lib/dom", "ace/lib/oop", "ace/lib/keys", "ace/lib/event", "ace/search", "ace/lib/useragent", "ace/search_highlight", "ace/commands/multi_select_commands", "ace/mode/text", "ace/multi_select"], function(e, t, n) {
    ...
    function M(e) {
        ...
        return r ? (V(n) && (t[t.length - 1] = n.toLowerCase()),
        "<" + t.join("-") + ">") : !1
    }
    function _(e) {
        var t = e.state.vim;
        return t.onPasteFn || (t.onPasteFn = function() {
            t.insertMode || (e.setCursor(Tt(e.getCursor(), 0, 1)),
    ...
    function Nt(e, t, n, r) {
        ...
        for (var u = 0; u < t.length; u++) {
            var a = t[u];
            if (n == "insert" && a.context != "insert" || a.context && a.context != n || r.operator && a.type == "action" || !(i = Ct(e, a.keys)))
                continue;
            i == "partial" && s.push(a),
            i == "full" && o.push(a)
        }
    ...
    function Dt(e, t) {
        return arguments.length > 2 && (t = Dt.apply(undefined, Array.prototype.slice.call(arguments, 1))),
        Mt(e, t) ? t : e
    }
    function Pt(e, t, n) {
        var r = Mt(e, t)
        ...
        var n = t.lastSelection
          ...
          , i = function() {
            ...
            if (i) {
                ...
                n.visualLine && (t = S(t.line, 0),
                r = S(r.line, Ht(e, r.line))),
                e.setSelection(t, r)
            }
            return [t, r]
        };
    ...
    function Wt(e, t, n) {
        ...
        i = Dt(i, n),
        i = Tt(i, 0, -1),
        i.ch == -1 && i.line != e.firstLine() && (i = S(i.line - 1, Ht(e, i.line - 1)))),
        [s, i]
    }
    function Xt(e, t, n) {
        var r = e.state.vim;
    ...
    function $t(e) {
        ...
        return e.getSelection().length == 1 && (t = _t(t, e.getCursor("anchor"))),
        t
    }
    function Jt(e, t) {
        var n = e.state.vim;
    ...
    function on(e, t, n, r, i, s) {
        ...
        for (var f = 0; f < n; f++) {
            ...
            u.push(l),
            t = S(l.line, r ? l.to - 1 : l.from)
        }
        var h = u.length != n
          , p = u[0]
          , d = u.pop();
        return r && !i ? (!h && (p.from != o.ch || p.line != o.line) && (d = u.pop()),
        S(d.line, d.from)) : r && i ? S(d.line, d.to - 1) : !r && i ? (!h && (p.to != o.ch || p.line != o.line) && (d = u.pop()),
        S(d.line, d.to)) : S(d.line, d.from)
    }
    function un(e, t, n, r) {
    ...
    function hn(e, t, n, r) {
        ...
        function s(e, t, n, r) {
            ...
            while (u.line !== null) {
                ...
                J(u.line[u.pos]) && !o && (u.pos === u.line.length - 1 || $(u.line[u.pos + 1])) && (o = !0),
                i(e, u)
            }
        ...
        function o(e, t, n, r) {
            ...
            while (o.line !== null) {
                ...
                if (!(!J(o.line[o.pos]) || u.pos === null || o.ln === u.ln && o.pos + 1 === u.pos))
                    return u;
                o.line !== "" && !$(o.line[o.pos]) && (a = !1,
                u = {
                    ln: o.ln,
                    pos: o.pos
                }),
    ...
    function gn(e, t, n, r, i) {
        e.openDialog ? e.openDialog(t, r, {
            ...
            selectValueOnOpen: !1,
            onClose: function() {
                e.state.vim && (e.state.vim.status = "",
    ...
    function Tn(e) {
        ...
        for (var r = -1; r < e.length; r++) {
            var i = e.charAt(r) || ""
              , s = e.charAt(r + 1) || "";
            xn[i + s] ? (n.push(xn[i + s]),
            r++) : t ? (n.push(i),
            t = !1) : i === "\\" ? (t = !0,
            X(s) || s === "$" ? n.push("$") : s !== "/" && s !== "\\" && n.push("\\")) : (i === "$" && n.push("$"),
            n.push(i),
            s === "/" && n.push("\\"))
        }
        return n.join("")
    ...
    function An(e, t) {
        ...
        return t && (n += ' <span style="color: #888">' + t + "</span>"),
        n
    }
    function Mn(e, t) {
    ...
    function Dn(e, t, n, r) {
        ...
        if (!s)
            return;
        return Hn(e, s),
        _n(s, i.getQuery()) ? s : (i.setQuery(s),
        s)
    }
    function Pn(e) {
    ...
    function Xn(e) {
        ...
        i || (e.off("change", Yn),
        v.off(e.getInputField(), "keydown", rr)),
        !i && t.insertModeRepeat > 1 && (ir(e, t, t.insertModeRepeat - 1, !0),
    ...
    function Jn(e, t, n, r) {
        ...
        if (r == ":") {
            i.keyBuffer[0] && zn.processCommand(e, i.keyBuffer[0]),
            n.isPlaying = !1;
            return
        }
        var s = i.keyBuffer
    ...
    function tr(e, t, n) {
        var r = e.getCursor("anchor")
          , i = e.getCursor("head");
        t.visualMode && !e.somethingSelected() ? Jt(e, !1) : !t.visualMode && !t.insertMode && e.somethingSelected() && (t.visualMode = !0,
        t.visualLine = !1,
        v.signal(e, "vim-mode-change", {
            mode: "visual"
        }));
    ...
    function sr(e, t, n) {
        ...
        for (var o = 0; o < n; o++) {
            ...
            for (var u = 0; u < t.length; u++) {
                var a = t[u];
                if (a instanceof nr)
                    v.lookupKey(a.keyName, "vim-insert", r);
    ...
    function fr(e) {
        ...
        return Object.keys(e).forEach(function(n) {
            var r = e[n];
            Array.isArray(r) ? r = r.slice() : r && typeof r == "object" && r.constructor != Object && (r = fr(r)),
            t[n] = r
        }),
        e.sel && (t.sel = {
        ...
        if (t == "<Esc>" && !i.insertMode && !i.visualMode && o)
            ...
            e.operation(function() {
                e.ace.forEachSelection(function() {
                    ...
                    e.virtualSelectionMode() && (e.state.vim = fr(u))
                }),
                e.curOp.cursorActivity && !r && (e.curOp.cursorActivity = !1)
            }, !0)
        }
        return r && !i.visualMode && !i.insert && i.visualMode != e.somethingSelected() && tr(e, i, !0),
        r
    }
    function hr(e, t) {
    ...
    v.keyName = function(e) {
        ...
        t = f.getModifierString(e).replace(/(^|-)\w/g, function(e) {
    ...
    v.isWordChar = function(e) {
        return e < "" ? /^\w$/.test(e) : (d.lastIndex = 0,
        d.test(e))
    }
    ,
    function() {
        ...
        this.onSelectionChange = function() {
            ...
            e.cursorActivityHandlers || (e.cursorActivityHandlers = this._eventRegistry.cursorActivity && this._eventRegistry.cursorActivity.slice()),
        ...
        this.operation = function(e, t) {
            ...
            this.curOp.force = t;
            var i = e();
            return this.ace.curOp && this.ace.curOp.command.name == "vim" && (this.state.dialog && (this.ace.curOp.command.scrollIntoView = !1),
        ...
        this.onBeforeEndOperation = function() {
            var e = this.curOp;
            e && (e.change && this.signal("change", e.change, e),
        ...
        this.scanForBracket = function(e, t, n, r) {
            ...
            if (t == 1)
                ...
                var o = this.ace.session.$findOpeningBracket(i.slice(-2, -1), {
                    row: e.line,
                    column: e.ch + 1
                }, s);
            return o && {
    ...
    function() {
        ...
        v.defineExtension("openDialog", function(n, r, i) {
            ...
            if (f)
                ...
                i.onInput && v.on(f, "input", function(e) {
    ...
    var it, ot, ut = {
        ...
        findKey: function(e, t, n) {
            ...
            function s() {
                if (t == "<Esc>")
                    return ft(e),
                    r.visualMode ? Jt(e) : r.insertMode && Xn(e),
                    !0
            }
            function o(n) {
                var r;
            ...
            function u() {
                ...
                if (o.type == "none")
                    ...
                    !1;
                if (o.type == "partial")
                    return ot && window.clearTimeout(ot),
    ...
    ht.prototype = {
        pushText: function(e, t, n, r, i) {
            ...
            if (!s) {
                ...
                case "delete":
                case "change":
                    n.indexOf("\n") == -1 ? this.registers["-"] = new lt(n,r) : (this.shiftNumericRegisters_(),
    ...
    var dt = {
        ...
        processOperator: function(e, t, n) {
            ...
            n.exitVisualBlock && (t.visualBlock = !1,
            Xt(e)),
        ...
        processSearch: function(e, t, n) {
            ...
            function l(t, n, i) {
                ...
                s == "Up" || s == "Down" ? (o = s == "Up" ? !0 : !1,
                a = t.target ? t.target.selectionEnd : 0,
                n = it.searchHistoryController.nextMatch(n, o) || "",
                i(n),
                a && t.target && (t.target.selectionEnd = t.target.selectionStart = Math.min(a, t.target.value.length))) : s != "Left" && s != "Right" && s != "Ctrl" && s != "Alt" && s != "Shift" && it.searchHistoryController.reset();
                var f;
                try {
                    f = Dn(e, n, !0, !0)
                } catch (t) {}
                f ? e.scrollIntoView(Bn(e, !r, f), 30) : (jn(e),
                e.scrollTo(u.left, u.top))
            }
            function c(t, n, r) {
                var i = v.keyName(t);
                i == "Esc" || i == "Ctrl-C" || i == "Ctrl-[" || i == "Backspace" && n == "" ? (it.searchHistoryController.pushInput(n),
                it.searchHistoryController.reset(),
                Dn(e, o),
                jn(e),
                e.scrollTo(u.left, u.top),
                ...
                ft(e),
                r(),
                e.focus()) : i == "Up" || i == "Down" ? v.e_stop(t) : i == "Ctrl-U" && (v.e_stop(t),
                r(""))
            }
        ...
        processEx: function(e, t, n) {
            ...
            function i(t, n, r) {
                ...
                if (i == "Esc" || i == "Ctrl-C" || i == "Ctrl-[" || i == "Backspace" && n == "")
                    ...
                    r(),
                    e.focus();
                i == "Up" || i == "Down" ? (v.e_stop(t),
                s = i == "Up" ? !0 : !1,
                o = t.target ? t.target.selectionEnd : 0,
                n = it.exCommandHistoryController.nextMatch(n, s) || "",
                r(n),
                o && t.target && (t.target.selectionEnd = t.target.selectionStart = Math.min(o, t.target.value.length))) : i == "Ctrl-U" ? (v.e_stop(t),
                r("")) : i != "Left" && i != "Right" && i != "Ctrl" && i != "Alt" && i != "Shift" && it.exCommandHistoryController.reset()
            }
        ...
        evalInput: function(e, t) {
            var n = t.inputState, r = n.motion, i = n.motionArgs || {}, s = n.operator, o = n.operatorArgs || {}, u = n.registerName, a = t.sel, f = At(t.visualMode ? St(e, a.head) : e.getCursor("head")), l = At(t.visualMode ? St(e, a.anchor) : e.getCursor("anchor")), c = At(f), h = At(l), p, d, v;
            ...
            if (r) {
                ...
                if (i.toJumplist) {
                    ...
                    var g = it.jumpList
                      , y = g.cachedCursor;
                    y ? (Zt(e, y, m),
                    delete g.cachedCursor) : Zt(e, f, m)
                }
                m instanceof Array ? (d = m[0],
                p = m[1]) : p = m,
                p || (p = At(f));
                if (t.visualMode) {
            ...
            if (s) {
                if (o.lastSel) {
                    ...
                    b.visualLine ? p = S(h.line + w, h.ch) : b.visualBlock ? p = S(h.line + w, h.ch + E) : b.head.line == b.anchor.line ? p = S(h.line, h.ch + E) : p = S(h.line + w, h.ch),
                    t.visualMode = !0,
                ...
                if (t.visualMode) {
                    ...
                    if (N) {
                        ...
                        if (C == "block")
                            ...
                            C == "line" && (L[0].head = S(L[0].head.line + 1, 0))
                    }
                } else {
                    x = At(d || h),
                    T = At(p || c);
      ...
      , vt = {
        ...
        jumpToMark: function(e, t, n, r) {
            ...
            return n.linewise && (i = S(i.line, Gt(e.getLine(i.line)))),
            i
        },
        ...
        moveByScroll: function(e, t, n, r) {
            ...
            return e.scrollTo(null, i.top + a.top - u.top),
            s
        },
        ...
        moveToCharacter: function(e, t, n) {
            var r = n.repeat;
            return en(0, n),
            un(e, r, n.forward, n.selectedCharacter) || t
        },
      ...
      , yt = {
        change: function(e, t, n) {
            ...
            if (!s.visualMode) {
                ...
                if (a.motion == "moveByWords" && !$(i)) {
                    var f = /\s+$/.exec(i);
                    f && a.motionArgs && a.motionArgs.forward && (u = Tt(u, 0, -f[0].length),
                ...
                r = _t(n[0].head, n[0].anchor)
            }
            it.registerController.pushText(t.registerName, "change", i, t.linewise, n.length > 1),
            wt.enterInsertMode(e, {
                head: r
            }, e.state.vim)
        },
        "delete": function(e, t, n) {
            ...
            if (!s.visualBlock) {
                var o = n[0].anchor
                  , u = n[0].head;
                t.linewise && u.line != e.firstLine() && o.line == e.lastLine() && o.line == u.line - 1 && (o.line == e.firstLine() ? o.ch = 0 : o = S(o.line - 1, Ht(e, o.line - 1))),
                i = e.getRange(o, u),
                e.replaceRange("", o, u),
                r = o,
        ...
        indentAuto: function(e, t, n) {
            return e.execCommand("indentAuto"),
        ...
        changeCase: function(e, t, n, r, i) {
            ...
            return e.replaceSelections(o),
            t.shouldMoveCursor ? i : !e.state.vim.visualMode && t.linewise && n[0].anchor.line + 1 == n[0].head.line ? vt.moveToFirstNonWhiteSpaceCharacter(e, r) : t.linewise ? r : _t(n[0].anchor, n[0].head)
        },
        yank: function(e, t, n, r) {
            var i = e.state.vim
              , s = e.getSelection()
              , o = i.visualMode ? _t(i.sel.anchor, i.sel.head, n[0].head, n[0].anchor) : r;
            return it.registerController.pushText(t.registerName, "yank", s, t.linewise, i.visualBlock),
            o
        }
    }
      , wt = {
        ...
        scroll: function(e, t, n) {
            ...
            if (t.forward)
                u > f.top ? (a.line += (u - f.top) / i,
                a.line = Math.ceil(a.line),
                e.setCursor(a),
                f = e.charCoords(a, "local"),
                e.scrollTo(null, f.top)) : e.scrollTo(null, u);
            else {
                var l = u + e.getScrollInfo().clientHeight;
                l < f.bottom ? (a.line -= (f.bottom - l) / i,
                a.line = Math.floor(a.line),
                e.setCursor(a),
                f = e.charCoords(a, "local"),
                e.scrollTo(null, f.bottom - e.getScrollInfo().clientHeight)) : e.scrollTo(null, u)
            }
        },
        ...
        toggleOverwrite: function(e) {
            e.state.overwrite ? (e.toggleOverwrite(!1),
        ...
        enterInsertMode: function(e, t, n) {
            ...
            if (r == "eol")
                ...
                if (!n.visualMode)
                    return;
                n.visualBlock ? (s = S(Math.min(i.head.line, i.anchor.line), Math.min(i.head.ch, i.anchor.ch)),
                o = Math.abs(i.head.line - i.anchor.line) + 1) : i.head.line < i.anchor.line ? s = i.head : s = S(i.anchor.line, 0)
            } else if (r == "endOfSelectedArea") {
                if (!n.visualMode)
                    return;
                n.visualBlock ? (s = S(Math.min(i.head.line, i.anchor.line), Math.max(i.head.ch + 1, i.anchor.ch)),
                o = Math.abs(i.head.line - i.anchor.line) + 1) : i.head.line >= i.anchor.line ? s = Tt(i.head, 0, 1) : s = S(i.anchor.line, 0)
            ...
            it.macroModeState.isPlaying || (e.on("change", Yn),
            v.on(e.getInputField(), "keydown", rr)),
            n.visualMode && Jt(e),
            qt(e, s, o)
        },
        toggleVisualMode: function(e, t, n) {
            var r = t.repeat, i = e.getCursor(), s;
            n.visualMode ? n.visualLine ^ t.linewise || n.visualBlock ^ t.blockwise ? (n.visualLine = !!t.linewise,
            n.visualBlock = !!t.blockwise,
            v.signal(e, "vim-mode-change", {
                mode: "visual",
                subMode: n.visualLine ? "linewise" : n.visualBlock ? "blockwise" : ""
            }),
            Xt(e)) : Jt(e) : (n.visualMode = !0,
        ...
        paste: function(e, t, n) {
            ...
            if (d) {
                ...
                for (var v = 0; v < s.length; v++)
                    s[v] = s[v] == "" ? " " : s[v];
                r.ch += t.after ? 1 : 0,
                r.ch = Math.min(Ht(e, r.line), r.ch)
            } else
                p ? n.visualMode ? s = n.visualLine ? s.slice(0, -1) : "\n" + s.slice(0, s.length - 1) + "\n" : t.after ? (s = "\n" + s.slice(0, s.length - 1),
                r.ch = Ht(e, r.line)) : r.ch = 0 : r.ch += t.after ? 1 : 0;
            var m, g;
            if (n.visualMode) {
                n.lastPastedText = s;
                var y, b = Ut(e, n), w = b[0], E = b[1], x = e.getSelection(), T = e.listSelections(), N = (new Array(T.length)).join("1").split("1");
                ...
                e.replaceRange(s, r),
                p && t.after ? m = S(r.line + 1, Gt(e.getLine(r.line + 1))) : p && !t.after ? m = S(r.line, Gt(e.getLine(r.line))) : !p && t.after ? (g = e.indexFromPos(r),
        ...
        replace: function(e, t, n) {
            ...
            if (r == "\n")
                ...
                n.visualMode ? (i = Mt(u[0].anchor, u[0].head) ? u[0].anchor : u[0].head,
                e.setCursor(i),
                Jt(e, !1)) : e.setCursor(Tt(o, 0, -1))
            }
        },
        incrementNumberToken: function(e, t) {
            ...
            e.setCursor(S(n.line, o + a.length - 1))
        },
    ...
    Rn.prototype = {
        ...
        parseInput_: function(e, t, n) {
            t.eatWhile(":"),
            t.eat("%") ? (n.line = e.firstLine(),
            n.lineEnd = e.lastLine()) : (n.line = this.parseLineSpec_(e, t),
            n.line !== undefined && t.eat(",") && (n.lineEnd = this.parseLineSpec_(e, t)));
            var r = t.match(/^(\w+)/);
            return r ? n.commandName = r[1] : n.commandName = t.match(/.*/)[0],
            n
        },
    ...
    var Un = {
        ...
        registers: function(e, t) {
            ...
            if (!n)
                ...
                for (var u = 0; u < n.length; u++) {
                    s = n.charAt(u);
                    if (!it.registerController.isValidRegister(s))
                        continue;
                    var a = r[s] || new lt;
                    i += '"' + s + "    " + a.toString() + "<br>"
                }
        ...
        sort: function(e, t) {
            ...
            function E(e, t) {
                ...
                var o = s && d.exec(e)
                  , u = s && d.exec(t);
                return o ? (o = parseInt((o[1] + o[2]).toLowerCase(), m),
        ...
        global: function(e, t) {
            ...
            var r = t.line !== undefined ? t.line : e.firstLine(), i = t.lineEnd || t.line || e.lastLine(), s = yn(n), o = n, u;
            s.length && (o = s[0],
        ...
        substitute: function(e, t) {
            ...
            if (r.length)
                ...
                s = s ? s + "\n" : "\n"),
                s !== undefined && (Z("pcre") ? s = Cn(s) : s = Tn(s),
    ...
    t.handler = {
        ...
        handleKeyboard: function(e, t, n, r, i) {
            ...
            if (r == -1)
                return;
            u.insertMode || (t == -1 ? (n.charCodeAt(0) > 255 && e.inputKey && (n = e.inputKey,
            n && e.inputHash == 4 && (n = n.toUpperCase())),
            e.inputChar = n) : t == 4 || t == 0 ? e.inputKey == n && e.inputHash == t && e.inputChar ? (n = e.inputChar,
            t = -1) : (e.inputChar = null,
            e.inputKey = n,
            e.inputHash = t) : e.inputChar = e.inputKey = null);
    ...
    wt.aceCommand = function(e, t, n) {
        e.vimCmd = t,
        e.ace.inVirtualSelectionMode ? e.ace.on("beforeEndOperation", hr) : hr(null, e.ace)
    }
    ,
