define("ace/occur", ["require", "exports", "module", "ace/lib/oop", "ace/range", "ace/search", "ace/edit_session", "ace/search_highlight", "ace/lib/dom"], function(e, t, n) {
    ...
    function() {
        this.enter = function(e, t) {
            ...
            return e.moveCursorToPosition(r),
            !0
        }
        ,
        this.exit = function(e, t) {
            ...
            return this.displayOriginalContent(e),
    ...
    function() {
        this.attach = function(e) {
            ...
            this.$commandExecHandler = e.commands.addEventListener("exec", function(t) {
                ...
                return e.renderer.scrollCursorIntoView(null, .5),
...
define("ace/incremental_search", ["require", "exports", "module", "ace/lib/oop", "ace/range", "ace/search", "ace/search_highlight", "ace/commands/incremental_search_commands", "ace/lib/dom", "ace/commands/command_manager", "ace/editor", "ace/config"], function(e, t, n) {
    ...
    function() {
        ...
        this.deactivate = function(e) {
            ...
            this.$mousedownHandler && (t.removeEventListener("mousedown", this.$mousedownHandler),
        ...
        ,
        this.curedSearch = function(e) {
            var t = this.$editor;
            return this.$prevNeedle = this.$options.needle,
            this.$options.needle = "",
            e ? (t.moveCursorToPosition(this.$startPos),
            this.$currentPos = this.$startPos) : t.pushEmacsMark && t.pushEmacsMark(this.$startPos, !1),
            this.highlight(null),
        ...
        this.highlightAndFindWithNeedle = function(e, t) {
            ...
            return s && (n.backwards && (s = i.fromPoints(s.end, s.start)),
            this.$editor.selection.setRange(i.fromPoints(o ? this.$startPos : s.end, s.end)),
            this.$editor.renderer.scrollCursorIntoView(this.$editor.getCursorPosition(), .5),
        ...
        this.removeChar = function(e) {
            return this.highlightAndFindWithNeedle(!1, function(e) {
                ...
                var t = c(e);
                return t.expression = t.expression.substring(0, t.expression.length - 1),
                p(t)
            })
        }
        ,
        ...
        this.message = function(e) {
            this.$editor.showCommandLine ? (this.$editor.showCommandLine(e),
            this.$editor.focus()) : console.log(e)
        }
    }
    .call(f.prototype),
...
define("ace/keyboard/emacs", ["require", "exports", "module", "ace/lib/dom", "ace/incremental_search", "ace/commands/incremental_search_commands", "ace/keyboard/hash_handler", "ace/lib/keys"], function(e, t, n) {
    ...
    t.handler.attach = function(e) {
        o || (o = !0,
        r.importCssString("            .emacs-mode .ace_cursor{                border: 1px rgba(50,250,50,0.8) solid!important;                box-sizing: border-box!important;                background-color: rgba(0,250,0,0.9);                opacity: 0.5;            }            .emacs-mode .ace_hidden-cursors .ace_cursor{                opacity: 1;                background-color: transparent;            }            .emacs-mode .ace_overwrite-cursors .ace_cursor {                opacity: 1;                background-color: transparent;                border-width: 0 0 2px 2px !important;            }            .emacs-mode .ace_text-layer {                z-index: 4            }            .emacs-mode .ace_cursor-layer {                z-index: 2            }", "emacsMode")),
        ...
        e.popEmacsMark = function() {
            ...
            return e ? (this.setEmacsMark(null),
            e) : this.session.$emacsMarkRing.pop()
        }
        ,
        ...
        e.emacsMarkForSelection = function(e) {
            var t = this.selection
              ...
              , s = i.length - (n - r)
              , o = i[s] || t.anchor;
            return e && i.splice(s, 1, "row"in e && "column"in e ? e : undefined),
            o
        }
        ,
        e.on("click", l),
    ...
    t.handler.handleKeyboard = function(e, t, n, r) {
        ...
        if (o == "c-" || e.count) {
            ...
            if (typeof u == "number" && !isNaN(u))
                return e.count = Math.max(e.count, 0) || 0,
        ...
        var f;
        typeof a != "string" && (f = a.args,
        a.command && (a = a.command),
        a === "goorselect" && (a = i.emacsMark() ? f[1] : f[0],
        f = null));
        if (typeof a == "string") {
    ...
    t.handler.addCommands({
        recenterTopBottom: function(e) {
            var t = e.renderer
              ...
              , i = t.scrollTop;
            Math.abs(n.top - i) < 2 ? i = n.top - r : Math.abs(n.top - i - r * .5) < 2 ? i = n.top : i = n.top - r * .5,
        ...
        killLine: function(e) {
            ...
            i && n.end.row != i.end.row && (n.end.row = i.end.row,
            r = "x"),
            /^\s*$/.test(r) && (n.end.row++,
    ...
    t.killRing = {
        ...
        pop: function() {
            return this.$data.length > 1 && this.$data.pop(),
            this.get()
        },
        rotate: function() {
