!function(e, t) {
        ...
        var n = function() {
            ...
            e.prototype.decode = function(e, t) {
                ...
                if (this.interim[0]) {
                    ...
                    h || (2 === d ? u < 128 ? l-- : t[a++] = u : 3 === d ? u < 2048 || u >= 55296 && u <= 57343 || (t[a++] = u) : u < 65536 || u > 1114111 || (t[a++] = u)),
                    this.interim.fill(0)
                }
    ...
    , function(e, t, r) {
        ...
        var o, s = r(12), a = r(20), c = r(39), l = r(2), h = r(15), u = r(8), f = r(16), _ = r(0), d = r(3), p = r(4), v = r(6), g = r(22), y = r(24), b = {
            "(": 0,
            ")": 1,
            "*": 2,
            "+": 3,
            ...
            e.prototype.unhook = function(e) {
                if (e) {
                    ...
                    case " q":
                        ...
                        return i -= this._optionsService.options.cursorBlink ? 1 : 0,
          ...
          , C = function(e) {
            function t(t, r, i, n, o, l, h, d, v) {
                ...
                y._parser.setDcsHandler({
                    intermediates: "$",
                    final: "q"
                }, new m(y._bufferService,y._coreService,y._logService,y._optionsService)),
                y
            }
            return n(t, e),
            ...
            t.prototype.insertChars = function(e) {
                ...
                t && (t.insertCells(this._bufferService.buffer.x, e.params[0] || 1, this._bufferService.buffer.getNullCell(this._eraseAttrData()), this._eraseAttrData()),
                this._dirtyRowService.markDirty(this._bufferService.buffer.y))
            }
            ,
            t.prototype.deleteChars = function(e) {
                this._restrictCursor();
                var t = this._bufferService.buffer.lines.get(this._bufferService.buffer.ybase + this._bufferService.buffer.y);
                t && (t.deleteCells(this._bufferService.buffer.x, e.params[0] || 1, this._bufferService.buffer.getNullCell(this._eraseAttrData()), this._eraseAttrData()),
                this._dirtyRowService.markDirty(this._bufferService.buffer.y))
            }
            ,
            ...
            t.prototype.eraseChars = function(e) {
                this._restrictCursor();
                var t = this._bufferService.buffer.lines.get(this._bufferService.buffer.ybase + this._bufferService.buffer.y);
                t && (t.replaceCells(this._bufferService.buffer.x, this._bufferService.buffer.x + (e.params[0] || 1), this._bufferService.buffer.getNullCell(this._eraseAttrData()), this._eraseAttrData()),
                this._dirtyRowService.markDirty(this._bufferService.buffer.y))
            }
            ,
                ...
                do {
                    ...
                    e.hasSubParams(t + o)) {
                        ...
                        do {
                            5 === i[1] && (n = 1),
                            i[o + a + 1 + n] = s[a]
                        } while (++a < s.length && a + o + 1 + n < i.length);break
                    }
                    if (5 === i[1] && o + n >= 2 || 2 === i[1] && o + n >= 5)
                        break;
                    i[1] && (n = 1)
                } while (++o + t < e.length && o + n < i.length);for (a = 2; a < i.length; ++a)
                    -1 === i[a] && (i[a] = 0);
                switch (i[0]) {
                case 38:
    ...
    , function(e, t, r) {
        ...
        var c = function() {
            ...
            e.prototype.unhook = function(e) {
                var t;
                return this._hitLimit ? t = !1 : e && (t = this._handler(this._data, this._params || new n.Params)),
                this._params = void 0,
                this._data = "",
                this._hitLimit = !1,
                t
    ...
    , function(e, t, r) {
        ...
        var i = function() {
            ...
            return e.prototype.dispose = function() {
                this._animationFrame && (window.curedAnimationFrame(this._animationFrame),
        ...
        var o = r(36)
          ...
          , O = function(e) {
            ...
            t.prototype.bindMouse = function() {
                ...
                this.register(d.addDisposableDomListener(r, "wheel", (function(t) {
                    if (!n.wheel)
                        return e.viewport.onWheel(t) ? void 0 : e.cured(t)
                }
                ), {
                    passive: !1
                })),
                ...
                this.register(d.addDisposableDomListener(r, "touchmove", (function(t) {
                    if (!e._coreMouseService.areMouseEventsActive)
                        return e.viewport.onTouchMove(t) ? void 0 : e.cured(t)
                }
                ), {
                    passive: !1
                }))
            ...
            t.prototype._keyDown = function(e) {
                ...
                !!this._isThirdLevelShift(this.browser, e) || (t.cured && this.cured(e, !0),
                ...
                this.optionsService.options.screenReaderMode ? void (this._keyDownHandled = !0) : this.cured(e, !0)))
            }
            ,
            ...
            ,
            t.prototype.cured = function(e, t) {
                if (this.options.curedEvents || t)
                ...
                e) {
                    ...
                    setTimeout((function() {
                        if (t._isSendingComposition) {
                            ...
                            var e = void 0;
                            e = t._isComposing ? t._textarea.value.substring(r.start, r.end) : t._textarea.value.substring(r.start),
        ...
        var a = r(2)
          ...
          , u = function(e) {
            ...
            t.prototype._bubbleScroll = function(e, t) {
                ...
                return !(t < 0 && 0 !== this._viewportElement.scrollTop || t > 0 && r < this._lastRecordedBufferHeight) || (e.curedable && e.preventDefault(),
                !1)
            }
            ,
    ...
    , function(e, t, r) {
        ...
        function o(e, t, r) {
            e = n(e = i(e), r.decPrivateModes.bracketedPasteMode),
        ...
        t.handlePasteEvent = function(e, t, r) {
            e.stopPropagation(),
            e.clipboardData && o(e.clipboardData.getData("text/plain"), t, r)
        }
        ,
        t.paste = o,
        ...
        var a = r(11)
          ...
          , y = function(e) {
            ...
            t.prototype._onMouseUp = function(e) {
                ...
                this.selectionText.length <= 1 && t < 500 && e.altKey) {
          ...
          , f = function(e) {
            ...
            t.prototype._renderRows = function(e, t) {
                for (var r = this._terminal.buffer, i = r.lines.length.toString(), n = e; n <= t; n++) {
                    ...
                    a && (0 === o.length ? a.innerHTML = "&nbsp;" : a.textContent = o,
        ...
        var a = r(58)
          ...
          , v = function(e) {
            ...
            t.prototype._injectCss = function() {
                ...
                t += this._terminalSelector + " .xterm-fg-" + c.INVERTED_DEFAULT_COLOR + " { color: " + _.color.opaque(this._colors.background).css + "; }" + this._terminalSelector + " .xterm-bg-" + c.INVERTED_DEFAULT_COLOR + " { background-color: " + this._colors.foreground.css + "; }",
            ...
            default:
                if (!e.ctrlKey || e.shiftKey || e.altKey || e.metaKey)
                    if (r && !o || !e.altKey || e.metaKey)
                        r && !e.altKey && !e.ctrlKey && e.metaKey ? 65 === e.keyCode && (s.type = 1) : e.key && !e.ctrlKey && !e.altKey && !e.metaKey && e.keyCode >= 48 && 1 === e.key.length ? s.key = e.key : e.key && e.ctrlKey && "_" === e.key && (s.key = i.C0.US);
                    else {
                        var c = n[e.keyCode]
    ...
    , function(e, t, r) {
        ...
        var u = function(e) {
            ...
            r.prototype.reset = function() {
                this.buffers.dispose(),
                this.buffers = new c.BufferSet(this._optionsService,this),
    ...
    , function(e, t, r) {
        ...
        var o = r(70)
          ...
          , a = function(e) {
            function t(t, r) {
                var i = e.call(this) || this;
                return i._onBufferActivate = i.register(new s.EventEmitter),
                i._normal = new o.Buffer(!0,t,r),
                i._normal.fillViewportRows(),
                i._alt = new o.Buffer(!1,t,r),
                ...
                if (l.isWrapped) {
                    ...
                    if (n >= a && n < c)
                        ...
                        for (var u = 0, f = i(h, u, t), _ = 1, d = 0; _ < h.length; ) {
                            ...
                            (d += y) === p && (_++,
                            d = 0),
                            0 === f && 0 !== u && 2 === h[u - 1].getWidth(r - 1) && (h[u].copyCellsFrom(h[u - 1], r - 1, f++, 1, !1),
                            h[u - 1].setCell(r - 1, o))
                        }
