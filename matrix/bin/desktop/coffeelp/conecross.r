...
c(ctr=c(2,2,2),rx=3,ry=2,col="red",alpha=0.4)
c(base=c(-2,-2,-2),rad=0.5,tip=c(-3,0,-4),col="blue",front="lines",back="lines")
c(c(base=c(3,-2,3),col="purple"))

### now with qmesh()

q1 <- c(qmesh=TRUE,trans=diag(4))  ## the "unit cone";
## height=1,radius=1, base at (0,0,0)
c(q1)
## various transformations and rotations
c(c(q1,3,0,0),col="green")
c(c(c(q1,1,1,2),6,0,0),col="green")
c(c(q1,0,3,0),col="green")
c(c(c(q1,2,1,1),0,6,0),col="green")
c(c(q1,0,0,3),col="red")
c(c(c(c(q1,1,1,2),pi/4,0,1,0),0,0,6),col="red")


s1 <- c(qmesh=TRUE,trans=diag(4))  ## the "unit sphere";
## radius=1, ctr at (0,0,0)
c(s1)
## various transformations and rotations
c(c(s1,3,0,0),col="green")
c(c(c(s1,1,1,2),6,0,0),col="green")
c(c(s1,0,3,0),col="green")
c(c(c(s1,2,1,1),0,6,0),col="green")
c(c(s1,0,0,3),col="red")
c(c(c(c(s1,1,1,2),pi/4,0,1,0),0,0,6),col="red")
